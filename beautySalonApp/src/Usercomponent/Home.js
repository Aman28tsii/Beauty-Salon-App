...
const Home = () => {
   ...
   <ul className='list-members'>
     <li className='member'>
       ...
       <img src={require("../images/Hairstylist.png")}/>
       </div>
     ...
     <li className='member'>
       <div className='member-image'>
       <img src={require("../images/Screenshot 2024-04-05 130722.png")}/>
       </div>
       <div className='member-info'>
         <h3>liya kebede</h3>
         <p>Makeup artist</p>
     ...
     <li className='member'>
       <div className='member-image'>
         <img src={require('../images/Cosmetic-Surgeon.jpg')} />
     ...
     <li className='member'>
       <div className='member-image'>
       <img src={require('../images/photo_2024-04-05_13-15-39.jpg')} />
       </div>
       <div className='member-info'>
         <h3>Melat Seleshi</h3>
         <p>Nail Artist</p>
